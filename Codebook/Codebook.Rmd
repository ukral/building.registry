...
# Import dataset
dataset <- read.table("Dataset.csv", sep = ";", header = TRUE, encoding="UTF-8", stringsAsFactors = F)
...
# Introduction
This Codebook refers to the dataset [Building schematic of Vienna in the late 1920s](Dataset.csv), briefly called digital building schematic. The dataset includes `r nrow(dataset)` data entries (rows) and `r ncol(dataset)` data fields (columns).
